...
// CONCATENATED MODULE: ./src/components/information/Information.js
...
function (_Component) {
  ...
  _createClass(Information, [{
    key: "renderBlog",
    value: function renderBlog(renderPage) {
      var query = this.props.query;
      return renderPage.map(function (item, index) {
        return external__react__default.a.createElement("div", {
        ...
        }))), query && query.slug ? external__react__default.a.createElement("div", null, external__react__default.a.createElement("div", {
          ...
          dangerouslySetInnerHTML: {
            __html: item.content.rendered.slice(0, item.content.rendered.indexOf(".</p>", 1))
          }
        }), external__react__default.a.createElement(routes["Link"], {
          prefetch: true,
          to: "/info/" + item.slug
        }, external__react__default.a.createElement("a", null, " Continue reading"))));
      });
    }
  }, {
    key: "renderNewer",
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement("article", {
        ...
        className: "blog-content",
        lg: 15
      }, this.renderBlog(renderPage), external__react__default.a.createElement("div", {
        className: "blog-resent"
      }, this.renderNewer(parseInt(query.page)), external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/info/page/2"
      }, external__react__default.a.createElement("a", null, "Older posts >>")))), external__react__default.a.createElement(col__default.a, {
        ...
        className: "post-list"
      }, parsedInfoPage.data.map(function (item, index) {
...
// EXTERNAL MODULE: ./src/components/information/_information.less
var _information = __webpack_require__(199);
var _information_default = /*#__PURE__*/__webpack_require__.n(_information);

// CONCATENATED MODULE: ./src/components/information/InformationContainer.js


function InformationContainer__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { InformationContainer__typeof = function _typeof(obj) { return typeof obj; }; } else { InformationContainer__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return InformationContainer__typeof(obj); }
...
function InformationContainer__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function InformationContainer__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function InformationContainer__createClass(Constructor, protoProps, staticProps) { if (protoProps) InformationContainer__defineProperties(Constructor.prototype, protoProps); if (staticProps) InformationContainer__defineProperties(Constructor, staticProps); return Constructor; }

function InformationContainer__possibleConstructorReturn(self, call) { if (call && (InformationContainer__typeof(call) === "object" || typeof call === "function")) { return call; } return InformationContainer__assertThisInitialized(self); }

function InformationContainer__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function InformationContainer__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var InformationContainer_InformationContainer =
/*#__PURE__*/
function (_Component) {
  InformationContainer__inherits(InformationContainer, _Component);

  function InformationContainer() {
    InformationContainer__classCallCheck(this, InformationContainer);

    return InformationContainer__possibleConstructorReturn(this, (InformationContainer.__proto__ || Object.getPrototypeOf(InformationContainer)).apply(this, arguments));
  }

  InformationContainer__createClass(InformationContainer, [{
    key: "render",
    value: function render() {
      var _props = this.props,
          infoPage = _props.infoPage,
          renderPage = _props.renderPage,
          title = _props.title;
      return external__react__default.a.createElement("div", null, infoPage && renderPage && external__react__default.a.createElement("div", null, external__react__default.a.createElement("style", {
        dangerouslySetInnerHTML: {
          __html: _information_default.a
        }
        ...
        property: "og:type",
        content: "article"
      })), external__react__default.a.createElement(Information_Information, _extends({}, this.props, {
        parsedInfoPage: external__circular_json__default.a.parse(infoPage),
    ...
    value: function () {
      ...
      regenerator__default.a.mark(function _callee(_ref) {
        var reduxStore, req, query, res, infoPage, renderPage, title, queryList;
        return regenerator__default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                reduxStore = _ref.reduxStore, req = _ref.req, query = _ref.query, res = _ref.res;
                infoPage = null, renderPage = null, title = "The Official Truckster Blog - Fun, Food & Drinks", queryList = [];
                _context.next = 4;
                return Object(global["c" /* getPageData */])(query.page ? query.page : 1);

              case 4:
                infoPage = _context.sent;
                renderPage = external__circular_json__default.a.parse(infoPage).data;

                if (query.slug) {
                  external__circular_json__default.a.parse(infoPage).data.forEach(function (element) {
...
/* harmony default export */ var info = __webpack_exports__["default"] = (InformationContainer_InformationContainer);
