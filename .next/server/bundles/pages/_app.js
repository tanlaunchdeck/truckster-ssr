...
var app_ = __webpack_require__(102);
...
var external__redux_devtools_extension_ = __webpack_require__(103);
...
var external__redux_thunk_ = __webpack_require__(104);
...
var profileReducer_profileReducer = function profileReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initial;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case types["_30" /* REQUEST_GET_USER */]:
      return {
        isLoadingUser: action.isLoadingUser
      };

    case types["S" /* GET_USER_SUCCESS */]:
      return _objectSpread({}, state, {
        isLoadingUser: false,
        userData: action.response
      });

    case types["L" /* GET_USER_ERROR */]:
      return {
        isLoadingUser: false,
        message: 'Something went wrong'
      };

    case types["_49" /* REQUEST_UPDATE_PROFILE */]:
      return _objectSpread({}, state, {
        error: null,
        isLoadingUpdateProfile: action.isLoadingUpdateProfile
      });

    case types["_76" /* UPDATE_PROFILE_SUCCESS */]:
      return _objectSpread({}, state, {
        isLoadingUpdateProfile: false,
    ...
    case types["_75" /* UPDATE_PROFILE_ERROR */]:
      return _objectSpread({}, state, {
        isLoadingUpdateProfile: false,
        message: 'Something went wrong'
      });

    case types["_14" /* REQUEST_CHANGE_PASSWORD */]:
      return _objectSpread({}, state, {
        isLoadingChangePassword: action.isLoadingChangePassword
      });

    case types["d" /* CHANGE_PASSWORD_SUCCESS */]:
      return _objectSpread({}, state, {
        isLoadingChangePassword: false
      });

    case types["c" /* CHANGE_PASSWORD_ERROR */]:
      return _objectSpread({}, state, {
        isLoadingChangePassword: false,
        message: 'Something went wrong'
      });
...
/* harmony default export */ var reducers_profileReducer = (profileReducer_profileReducer);
// CONCATENATED MODULE: ./src/reducers/toggleReducer.js

var toggleReducer_initial = {
  visibleSignIn: false,
  visibleSignUp: false,
  visibleForgot: false,
...
var toggleReducer_toggleReducer = function toggleReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : toggleReducer_initial;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case types["_69" /* TOGGLE_SIGN_IN_MODAL */]:
      return {
        visibleErrorSignUpPopOver: false,
    ...
    case types["_70" /* TOGGLE_SIGN_UP_MODAL */]:
      return {
    ...
    case types["_67" /* TOGGLE_FORGOT_MODAL */]:
      return {
        visibleForgot: !state.visibleForgot
      };

    case types["_65" /* TOGGLE_ERROR_SIGN_IN_POP_OVER */]:
      return {
        visibleSignIn: true,
        visibleErrorSignInPopOver: true
      };

    case types["_66" /* TOGGLE_ERROR_SIGN_UP_POP_OVER */]:
      return {
        visibleSignUp: true,
        visibleErrorSignUpPopOver: true
      };

    case types["_62" /* TOGGLE_ANNOUNCE_MODAL */]:
      return {
        visibleAnnounce: !state.visibleAnnounce
      };

    case types["_68" /* TOGGLE_SHARE_MODAL */]:
      return {
        url: action.url,
        visibleShare: !state.visibleShare
      };

    case types["_63" /* TOGGLE_CATERING_MODAL */]:
      return {
...
/* harmony default export */ var reducers_toggleReducer = (toggleReducer_toggleReducer);
// CONCATENATED MODULE: ./src/reducers/authReducer.js
function authReducer__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { authReducer__defineProperty(target, key, source[key]); }); } return target; }

function authReducer__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }


var authReducer_initial = {
  userData: null,
  token: null,
...
var authReducer_authReducer = function authReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : authReducer_initial;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case types["_46" /* REQUEST_SIGN_UP */]:
      return authReducer__objectSpread({}, state, {
        isLoadingSignUp: action.isLoadingSignUp
      });

    case types["_61" /* SIGN_UP_SUCCESS */]:
      return authReducer__objectSpread({}, state, {
        isLoadingSignUp: false,
        userData: action.response
      });

    case types["_60" /* SIGN_UP_ERROR */]:
    ...
    case types["_45" /* REQUEST_SIGN_IN */]:
      return authReducer__objectSpread({}, state, {
        isLoadingSignIn: action.isLoadingSignIn
      });

    case types["_59" /* SIGN_IN_SUCCESS */]:
      return authReducer__objectSpread({}, state, {
        isLoadingSignIn: false,
    ...
    case types["_35" /* REQUEST_LOGIN_SOCIAL */]:
      return authReducer__objectSpread({}, state, {
        isLoadingSignIn: action.isLoadingLoginSocial
      });

    case types["U" /* LOGIN_SOCIAL_SUCCESS */]:
      return authReducer__objectSpread({}, state, {
        isLoadingSignIn: false
      });

    case types["T" /* LOGIN_SOCIAL_ERROR */]:
      return authReducer__objectSpread({}, state, {
        isLoadingSignIn: false,
        message: 'Something went wrong'
      });

    case types["_36" /* REQUEST_LOG_OUT */]:
      return authReducer__objectSpread({}, state, {
        error: null,
        isLoadingLogOut: action.isLoadingLogOut
      });

    case types["W" /* LOG_OUT_SUCCESS */]:
      return authReducer__objectSpread({}, state, {
        isLoadingLogOut: false
      });

    case types["V" /* LOG_OUT_ERROR */]:
      return {
        isLoadingLogOut: false,
        message: 'Something went wrong'
      };
...
// CONCATENATED MODULE: ./src/reducers/truckReducer.js
var _initial;

function truckReducer__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { truckReducer__defineProperty(target, key, source[key]); }); } return target; }

function truckReducer__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }


var truckReducer_initial = (_initial = {
  isLoadingGetSuggestTruck: false,
  isLoadingSearchTruck: false,
  isLoadingGetTruckDetail: false
}, truckReducer__defineProperty(_initial, "isLoadingGetSuggestTruck", false), truckReducer__defineProperty(_initial, "isLoadingGetRecommendTruck", false), truckReducer__defineProperty(_initial, "isLoadingGetCuisineList", false), truckReducer__defineProperty(_initial, "recommendTruck", null), truckReducer__defineProperty(_initial, "suggestTruck", null), truckReducer__defineProperty(_initial, "truckDetail", null), truckReducer__defineProperty(_initial, "truckMenu", null), truckReducer__defineProperty(_initial, "suggestTruck", null), truckReducer__defineProperty(_initial, "trucks", []), truckReducer__defineProperty(_initial, "truckSearch", []), truckReducer__defineProperty(_initial, "foodSearchResult", null), truckReducer__defineProperty(_initial, "truckSearchResult", null), truckReducer__defineProperty(_initial, "isLoadingGetPairing", false), truckReducer__defineProperty(_initial, "truckFeatured", null), truckReducer__defineProperty(_initial, "truckFeaturedCity", null), truckReducer__defineProperty(_initial, "error", false), truckReducer__defineProperty(_initial, "currentPage", null), truckReducer__defineProperty(_initial, "lastPage", null), truckReducer__defineProperty(_initial, "currentPageType", null), truckReducer__defineProperty(_initial, "lastPageType", null), truckReducer__defineProperty(_initial, "total", null), truckReducer__defineProperty(_initial, "nearby", []), truckReducer__defineProperty(_initial, "params", ""), truckReducer__defineProperty(_initial, "cuisineList", []), _initial);

var truckReducer_truckReducer = function truckReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : truckReducer_initial;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    // Search truck reducer
    case types["_44" /* REQUEST_SEARCH_TRUCK */]:
      return truckReducer__objectSpread({}, state, {
        error: false,
        isLoadingSearchTruck: action.isLoadingSearchTruck
      });

    case types["_57" /* SEARCH_TRUCK_SUCCESS */]:
      if (!action.response.params) return truckReducer__objectSpread({}, state, {
        error: false,
        isLoadingSearchTruck: false,
      ...
      });else if (action.response.params === "food_item") return truckReducer__objectSpread({}, state, {
        isLoadingSearchTruck: false,
      ...
      } else if (action.response.params === "is_featured") return truckReducer__objectSpread({}, state, {
        isLoadingSearchTruck: false,
        truckFeatured: action.response.data
      });else if (action.response.params === "is_featured=true&city") return truckReducer__objectSpread({}, state, {
        isLoadingSearchTruck: false,
        truckFeaturedCity: action.response.data
      });else return truckReducer__objectSpread({}, state, {
        isLoadingSearchTruck: false,
    ...
    case types["_56" /* SEARCH_TRUCK_ERROR */]:
      return {
        isLoadingSearchTruck: false,
        error: true,
    ...
    case types["_27" /* REQUEST_GET_TRUCK_DETAIL */]:
      return truckReducer__objectSpread({}, state, {
        error: false,
        truckDetail: null,
    ...
    case types["E" /* GET_TRUCK_DETAIL_SUCCESS */]:
      return truckReducer__objectSpread({}, state, {
        error: false,
        isLoadingGetTruckDetail: false,
    ...
    case types["D" /* GET_TRUCK_DETAIL_ERROR */]:
      return truckReducer__objectSpread({}, state, {
        error: true,
        isLoadingGetTruckDetail: false,
        status: action.response.status,
    ...
    case types["_26" /* REQUEST_GET_SUGGEST_TRUCK */]:
      return truckReducer__objectSpread({}, state, {
        error: false,
        isLoadingGetSuggestTruck: action.isLoadingGetSuggestTruck
      });

    case types["C" /* GET_SUGGEST_TRUCK_SUCCESS */]:
      return truckReducer__objectSpread({}, state, {
        isLoadingGetSuggestTruck: false,
        suggestTruck: action.response.data
      });

    case types["B" /* GET_SUGGEST_TRUCK_ERROR */]:
      return truckReducer__objectSpread({}, state, {
        error: true,
        isLoadingGetSuggestTruck: false,
        status: action.response.status,
    ...
    case types["_74" /* UNMARK_FAVORITE_SUCCESS */]:
      return truckReducer__objectSpread({}, state, {
        truckDetail: truckReducer__objectSpread({}, state.truckDetail, {
          is_favourite: false
        })
      });

    case types["_0" /* MARK_FAVORITE_SUCCESS */]:
      return truckReducer__objectSpread({}, state, {
        truckDetail: truckReducer__objectSpread({}, state.truckDetail, {
          is_favourite: true
        })
...
/* harmony default export */ var reducers_truckReducer = (truckReducer_truckReducer);
// CONCATENATED MODULE: ./src/reducers/reviewReducer.js
var reviewReducer__initial;

function reviewReducer__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { reviewReducer__defineProperty(target, key, source[key]); }); } return target; }

function reviewReducer__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }


var reviewReducer_initial = (reviewReducer__initial = {
  reviews: null,
  userReview: null,
...
}, reviewReducer__defineProperty(reviewReducer__initial, "isLoadingMarkFavoriteBrewery", false), reviewReducer__defineProperty(reviewReducer__initial, "userFavorite", null), reviewReducer__defineProperty(reviewReducer__initial, "isLoadingEditBreweryReview", false), reviewReducer__defineProperty(reviewReducer__initial, "isLoadingGetUserBreweryReview", false), reviewReducer__defineProperty(reviewReducer__initial, "isLoadingPostBreweryReview", false), reviewReducer__defineProperty(reviewReducer__initial, "isLoadingGetBreweryReview", false), reviewReducer__defineProperty(reviewReducer__initial, "breweryReviews", null), reviewReducer__defineProperty(reviewReducer__initial, "userBreweryReview", null), reviewReducer__defineProperty(reviewReducer__initial, "userFavoriteBrewery", null), reviewReducer__initial);

var reviewReducer_reviewReducer = function reviewReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : reviewReducer_initial;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    // Get truck review reducer
    case types["_29" /* REQUEST_GET_TRUCK_REVIEW */]:
      return reviewReducer__objectSpread({}, state, {
        error: false,
        isLoadingGetTruckReview: action.isLoadingGetTruckReview
      });

    case types["I" /* GET_TRUCK_REVIEW_SUCCESS */]:
      return reviewReducer__objectSpread({}, state, {
        isLoadingGetTruckReview: false,
        reviews: action.response.data
      });

    case types["H" /* GET_TRUCK_REVIEW_ERROR */]:
      return reviewReducer__objectSpread({}, state, {
        error: true,
        isLoadingGetTruckReview: false,
        status: action.response.status,
    ...
    case types["_40" /* REQUEST_POST_REVIEW */]:
      return reviewReducer__objectSpread({}, state, {
        status: null,
        error: false,
    ...
    case types["_11" /* POST_REVIEW_SUCCESS */]:
      return reviewReducer__objectSpread({}, state, {
        isLoadingPostReview: false,
        status: 201,
        error: false
    ...
    case types["_10" /* POST_REVIEW_ERROR */]:
      return reviewReducer__objectSpread({}, state, {
        error: true,
        isLoadingPostReview: false,
        status: action.response.status,
    ...
    case types["_16" /* REQUEST_EDIT_REVIEW */]:
      return reviewReducer__objectSpread({}, state, {
        status: null,
        error: false,
    ...
    case types["i" /* EDIT_REVIEW_SUCCESS */]:
      return reviewReducer__objectSpread({}, state, {
        isLoadingEditReview: false,
        error: false,
        status: 201
    ...
    case types["h" /* EDIT_REVIEW_ERROR */]:
      return reviewReducer__objectSpread({}, state, {
        error: true,
        isLoadingEditReview: false,
        status: action.response.status,
    ...
    case types["_37" /* REQUEST_MARK_FAVORITE */]:
      return reviewReducer__objectSpread({}, state, {
        error: false,
    ...
    case types["Z" /* MARK_FAVORITE_ERROR */]:
      return reviewReducer__objectSpread({}, state, {
        error: true,
        isLoadingMarkFavorite: false,
        status: action.response.status,
    ...
    case types["_47" /* REQUEST_UNMARK_FAVORITE */]:
      return reviewReducer__objectSpread({}, state, {
        error: false,
    ...
    case types["_73" /* UNMARK_FAVORITE_ERROR */]:
      return reviewReducer__objectSpread({}, state, {
        error: true,
        isLoadingUnmarkFavorite: false,
        status: action.response.status,
    ...
    case types["_32" /* REQUEST_GET_USER_FAVORITE */]:
      return reviewReducer__objectSpread({}, state, {
        error: false,
        isLoadingGetUserFavorite: action.isLoadingGetUserFavorite
      });

    case types["P" /* GET_USER_FAVORITE_SUCCESS */]:
      return reviewReducer__objectSpread({}, state, {
        isLoadingGetUserFavorite: false,
        userFavorite: action.response.data[0].favourites_detail
      });

    case types["O" /* GET_USER_FAVORITE_ERROR */]:
      return reviewReducer__objectSpread({}, state, {
        error: true,
        isLoadingGetUserFavorite: false,
        status: action.response.status,
    ...
    case types["_39" /* REQUEST_POST_BREWERY_REVIEW */]:
      return reviewReducer__objectSpread({}, state, {
        status: null,
        error: false,
    ...
    case types["_9" /* POST_BREWERY_REVIEW_SUCCESS */]:
      return reviewReducer__objectSpread({}, state, {
    ...
    case types["_8" /* POST_BREWERY_REVIEW_ERROR */]:
      return reviewReducer__objectSpread({}, state, {
        error: true,
        isLoadingPostBreweryReview: false,
        status: action.response.status,
    ...
    case types["_15" /* REQUEST_EDIT_BREWERY_REVIEW */]:
      return reviewReducer__objectSpread({}, state, {
        status: null,
        error: false,
    ...
    case types["g" /* EDIT_BREWERY_REVIEW_SUCCESS */]:
      return reviewReducer__objectSpread({}, state, {
    ...
    case types["f" /* EDIT_BREWERY_REVIEW_ERROR */]:
      return reviewReducer__objectSpread({}, state, {
        error: true,
        isLoadingEditBreweryReview: false,
        status: action.response.status,
    ...
    case types["_38" /* REQUEST_MARK_FAVORITE_BREWERY */]:
      return reviewReducer__objectSpread({}, state, {
        error: false,
        isLoadingMarkFavoriteBrewery: action.isLoadingMarkFavoriteBrewery
      });

    case types["Y" /* MARK_FAVORITE_BREWERY_SUCCESS */]:
      return reviewReducer__objectSpread({}, state, {
        isLoadingMarkFavoriteBrewery: false
      });

    case types["X" /* MARK_FAVORITE_BREWERY_ERROR */]:
      return reviewReducer__objectSpread({}, state, {
        error: true,
        isLoadingMarkFavoriteBrewery: false,
        status: action.response.status,
    ...
    case types["_48" /* REQUEST_UNMARK_FAVORITE_BREWERY */]:
      return reviewReducer__objectSpread({}, state, {
        error: false,
        isLoadingUnmarkFavoriteBrewery: action.isLoadingUnmarkFavoriteBrewery
      });

    case types["_72" /* UNMARK_FAVORITE_BREWERY_SUCCESS */]:
      return reviewReducer__objectSpread({}, state, {
        isLoadingUnmarkFavoriteBrewery: false
      });

    case types["_71" /* UNMARK_FAVORITE_BREWERY_ERROR */]:
      return reviewReducer__objectSpread({}, state, {
        error: true,
        isLoadingUnmarkFavoriteBrewery: false,
        status: action.response.status,
...
/* harmony default export */ var reducers_reviewReducer = (reviewReducer_reviewReducer);
...
var external__immutability_helper_ = __webpack_require__(66);
...
// CONCATENATED MODULE: ./src/reducers/activityReducer.js
function activityReducer__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { activityReducer__defineProperty(target, key, source[key]); }); } return target; }

function activityReducer__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var activityReducer_activityReducer = function activityReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : activityReducer_initial;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    // Get truck review reducer
    case types["_42" /* REQUEST_SEARCH_ACTIVITY */]:
      return activityReducer__objectSpread({}, state, {
        error: false,
        isLoadingSearchActivity: action.isLoadingSearchActivity
      });

    case types["_51" /* SEARCH_ACTIVITY_SUCCESS */]:
      if (action.response.isFeature) {
        ...
        action.response.data.forEach(function (element) {
          ...
          for (var i = 0; i < events.length; ++i) {
            if (external__moment__default()(events[i], "YYYY-MM-DD h:mm a").unix() > external__moment__default()().unix()) {
              timeTemp = events[i];
              activitiesWeekState.push(activityReducer__objectSpread({}, element, {
        ...
        action.response.data.forEach(function (element) {
          ...
          _activitiesWeekState.push(activityReducer__objectSpread({}, element, {
            timeDisplay: timeTemp
          }));
        });
        _activitiesWeekState = external__lodash__default.a.orderBy(_activitiesWeekState, function (item) {
          return external__moment__default()(item.timeDisplay, "YYYY-MM-DD h:mm a").unix();
        });
        return activityReducer__objectSpread({}, state, {
          isLoadingSearchActivity: false,
    ...
    case types["_50" /* SEARCH_ACTIVITY_ERROR */]:
      return activityReducer__objectSpread({}, state, {
        error: true,
        isLoadingSearchActivity: false,
        status: action.response.status,
    ...
    case types["_17" /* REQUEST_GET_ACTIVITY_DETAIL */]:
      return activityReducer__objectSpread({}, state, {
        activity: null,
        error: false,
    ...
    case types["k" /* GET_ACTIVITY_DETAIL_SUCCESS */]:
      return activityReducer__objectSpread({}, state, {
        isLoadingGetActivityDetail: false,
        activity: action.response
      });

    case types["j" /* GET_ACTIVITY_DETAIL_ERROR */]:
      return activityReducer__objectSpread({}, state, {
        error: true,
        isLoadingGetActivityDetail: false,
        status: action.response.status,
...
/* harmony default export */ var reducers_activityReducer = (activityReducer_activityReducer);
// CONCATENATED MODULE: ./src/reducers/breweryReducer.js
function breweryReducer__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { breweryReducer__defineProperty(target, key, source[key]); }); } return target; }

function breweryReducer__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }


var breweryReducer_initial = {
...
var breweryReducer_breweryReducer = function breweryReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : breweryReducer_initial;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case types["_43" /* REQUEST_SEARCH_BREWERY */]:
      return breweryReducer__objectSpread({}, state, {
        error: false,
        isLoadingSearchBrewery: action.isLoadingSearchBrewery
      });

    case types["_53" /* SEARCH_BREWERY_SUCCESS */]:
      ...
      } else return breweryReducer__objectSpread({}, state, {
        isLoadingSearchBrewery: false,
    ...
    case types["_52" /* SEARCH_BREWERY_ERROR */]:
      return breweryReducer__objectSpread({}, state, {
        error: true,
        isLoadingSearchBrewery: false,
        status: action.response.status,
    ...
    case types["_18" /* REQUEST_GET_BREWERY_DETAIL */]:
      return breweryReducer__objectSpread({}, state, {
        error: false,
        brewery: null,
    ...
    case types["m" /* GET_BREWERY_DETAIL_SUCCESS */]:
      return breweryReducer__objectSpread({}, state, {
        error: false,
        isLoadingGetBreweryDetail: false,
    ...
    case types["l" /* GET_BREWERY_DETAIL_ERROR */]:
      return breweryReducer__objectSpread({}, state, {
        error: true,
        isLoadingGetBreweryDetail: false,
        status: action.response.status,
...
/* harmony default export */ var reducers_breweryReducer = (breweryReducer_breweryReducer);
// CONCATENATED MODULE: ./src/reducers/pairingReducer.js
function pairingReducer__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { pairingReducer__defineProperty(target, key, source[key]); }); } return target; }

function pairingReducer__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }


var pairingReducer_initial = {
  status: null,
  error: false,
...
var pairingReducer_pairingReducer = function pairingReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : pairingReducer_initial;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    // Get paring action
    case types["_22" /* REQUEST_GET_PAIRING */]:
      return pairingReducer__objectSpread({}, state, {
        status: null,
        error: false,
        isLoadingGetPairing: action.isLoadingGetPairing
      });

    case types["w" /* GET_PAIRING_SUCCESS */]:
      if (action.response.params === "is_featured=true&city") return pairingReducer__objectSpread({}, state, {
        isLoadingGetPairing: false,
        featuredPairings: action.response.data,
        currentPage: action.response.current_page,
        lastPage: action.response.last_page
      });else return pairingReducer__objectSpread({}, state, {
        isLoadingGetPairing: false,
    ...
    case types["v" /* GET_PAIRING_ERROR */]:
      return pairingReducer__objectSpread({}, state, {
        isLoadingGetPairing: false,
        status: action.response.status,
        message: action.response.statusText
    ...
    case types["_23" /* REQUEST_GET_PAIRING_DETAIL */]:
      return pairingReducer__objectSpread({}, state, {
        error: false,
        pairing: null,
    ...
    case types["u" /* GET_PAIRING_DETAIL_SUCCESS */]:
      return pairingReducer__objectSpread({}, state, {
        error: false,
        isLoadingGetPairingDetail: false,
    ...
    case types["t" /* GET_PAIRING_DETAIL_ERROR */]:
      return pairingReducer__objectSpread({}, state, {
        error: true,
        isLoadingGetPairingDetail: false,
        status: action.response.status,
...
/* harmony default export */ var reducers_pairingReducer = (pairingReducer_pairingReducer);
// CONCATENATED MODULE: ./src/reducers/nearbyReducer.js
function nearbyReducer__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { nearbyReducer__defineProperty(target, key, source[key]); }); } return target; }

function nearbyReducer__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }


var nearbyReducer_initial = {
...
var nearbyReducer_nearbyReducer = function nearbyReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : nearbyReducer_initial;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    // Get truck nearby action
    case types["_3" /* MOUNT_NEARBY */]:
      return nearbyReducer__objectSpread({}, state, {
        nearby: null,
        currentPage: 1,
        lastPage: 1
      });

    case types["_21" /* REQUEST_GET_NEARBY */]:
      return nearbyReducer__objectSpread({}, state, {
        error: false,
        isLoadingGetNearby: action.isLoadingGetNearby
      });

    case types["s" /* GET_NEARBY_SUCCESS */]:
      return nearbyReducer__objectSpread({}, state, {
        isLoadingGetNearby: false,
...
/* harmony default export */ var reducers_nearbyReducer = (nearbyReducer_nearbyReducer);
// CONCATENATED MODULE: ./src/reducers/deepLinkReducer.js
function deepLinkReducer__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { deepLinkReducer__defineProperty(target, key, source[key]); }); } return target; }

function deepLinkReducer__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }


var deepLinkReducer_initial = {
  params: null,
  visibleDeepLink: true
};

var deepLinkReducer_deepLinkReducer = function deepLinkReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : deepLinkReducer_initial;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case types["e" /* CHANGE_ROUTE */]:
      return deepLinkReducer__objectSpread({}, state, {
        params: action.params
      });

    case types["_64" /* TOGGLE_DEEP_LINK */]:
      return deepLinkReducer__objectSpread({}, state, {
...
/* harmony default export */ var reducers_deepLinkReducer = (deepLinkReducer_deepLinkReducer);
// CONCATENATED MODULE: ./src/reducers/cateringReducer.js
function cateringReducer__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { cateringReducer__defineProperty(target, key, source[key]); }); } return target; }

function cateringReducer__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }



var cateringReducer_initial = {
  cateringData: {},
...
var cateringReducer_cateringReducer = function cateringReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : cateringReducer_initial;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case types["_6" /* NEXT_STEP */]:
      return external__immutability_helper__default()(state, {
        step: {
          $set: state.step + 1
        },
        cateringData: {
          $merge: cateringReducer__objectSpread({}, action.payload)
        }
      });

    case types["_12" /* PREVIOUS_STEP */]:
      return external__immutability_helper__default()(state, {
        step: {
          $set: state.step - 1
        }
    ...
    case types["_13" /* REQUEST_CATERING */]:
      return external__immutability_helper__default()(state, {
        isLoadingCatering: {
          $set: true
        }
...
/* harmony default export */ var reducers_cateringReducer = (cateringReducer_cateringReducer);
// CONCATENATED MODULE: ./src/reducers/searchReducer.js


var searchReducer_initial = {
  searchResult: [],
...
var searchReducer_searchReducer = function searchReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : searchReducer_initial;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case types["_41" /* REQUEST_SEARCH */]:
      return external__immutability_helper__default()(state, {
        isLoadingSearch: {
          $set: true
        }
...
/* harmony default export */ var reducers_searchReducer = (searchReducer_searchReducer);
...
var rootReducer = Object(external__redux_["combineReducers"])({
  profileReducer: reducers_profileReducer,
  toggleReducer: reducers_toggleReducer,
  authReducer: reducers_authReducer,
  truckReducer: reducers_truckReducer,
  activityReducer: reducers_activityReducer,
  reviewReducer: reducers_reviewReducer,
  breweryReducer: reducers_breweryReducer,
  pairingReducer: reducers_pairingReducer,
  nearbyReducer: reducers_nearbyReducer,
  deepLinkReducer: reducers_deepLinkReducer,
  cateringReducer: reducers_cateringReducer,
  searchReducer: reducers_searchReducer
});
...
var external__next_redux_wrapper_ = __webpack_require__(105);
...
var dropdown_ = __webpack_require__(106);
...
var Header_menu = function menu(_ref) {
  var logOut = _ref.logOut;
  return external__react__default.a.createElement(menu__default.a, null, external__react__default.a.createElement(menu__default.a.Item, null, external__react__default.a.createElement(routes["Link"], {
    prefetch: true,
    to: "/user"
  }, external__react__default.a.createElement("a", {
    className: " Body-1MediumBlackLeft"
  }, "My profile"))), external__react__default.a.createElement(menu__default.a.Item, null, external__react__default.a.createElement(routes["Link"], {
    prefetch: true,
    to: "/edit"
  }, external__react__default.a.createElement("a", {
    className: " Body-1MediumBlackLeft"
  }, "Account Settings   "))), external__react__default.a.createElement(menu__default.a.Item, null, external__react__default.a.createElement("a", {
    onClick: logOut,
    className: " Body-1MediumBlackLeft"
  }, "Log Out")));
};

var Header_menuCity = function menuCity() {
  return external__react__default.a.createElement(menu__default.a, null, external__react__default.a.createElement(menu__default.a.Item, null, external__react__default.a.createElement(routes["Link"], {
    prefetch: true,
...
function (_Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement("header", {
      ...
      }, isLoggedIn ? !isLoadingGetUser && userData ? external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/user"
      }, external__react__default.a.createElement("a", {
      ...
      }, "Member Since: ", external__moment__default()(userData.create_at).format("MMMM DD,YYYY"))))) : external__react__default.a.createElement("a", {
        className: "item Body-1MediumBlackLeft"
        ...
        type: "primary"
      }, "SIGN UP"), external__react__default.a.createElement(button__default.a, {
        onClick: toggleSignInModal,
        className: "button-container button-container-login ButtonBlackCenter"
      }, "LOGIN"))), external__react__default.a.createElement("hr", null), external__react__default.a.createElement(dropdown__default.a, {
        getPopupContainer: function getPopupContainer() {
          return document.getElementById('area1');
        },
        overlay: Header_menuCity()
      }, external__react__default.a.createElement("span", {
        className: "dropdown-container"
      }, external__react__default.a.createElement("a", {
        id: "area1",
        className: "menu-drawer-city"
      }, external__react__default.a.createElement("img", {
        src: locationIcon,
        alt: "city"
      }), external__react__default.a.createElement("span", {
        className: "city-name"
      }, "All cities")))), external__react__default.a.createElement("hr", null), external__react__default.a.createElement("div", {
      ...
      }, "Map  ")), external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/brewery/co/denver"
      }, external__react__default.a.createElement("a", {
        onClick: handleOpenMenu,
        className: "item Body-2LeftGrey"
      }, "Breweries  ")), external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/food-truck/co/denver/all"
      }, external__react__default.a.createElement("a", {
        onClick: handleOpenMenu,
        className: "item Body-2LeftGrey"
      }, "Food Trucks  ")), external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/help"
      }, external__react__default.a.createElement("a", {
        onClick: handleOpenMenu,
        className: "item Body-2LeftGrey"
      }, "Help  "))), external__react__default.a.createElement("div", {
        className: "menu-drawer-item-group"
      }, external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/about"
        ...
        onClick: handleOpenMenu,
        className: "item Body-2LeftGrey"
      }, "About us ")), external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/privacy"
      }, external__react__default.a.createElement("a", {
        onClick: handleOpenMenu,
        className: "item Body-2LeftGrey"
      }, "Privacy & Terms "))), isLoggedIn && external__react__default.a.createElement("div", {
        className: "menu-drawer-item-group"
      }, external__react__default.a.createElement("a", {
        onClick: logOut,
        className: "item Body-2LeftGrey"
      }, "Log Out"))), external__react__default.a.createElement("div", {
        className: "menu-drawer-footer CaptionGreyLeft"
      }, "2018 \xA9 Truckster Inc."))), external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/"
        ...
        getPopupContainer: function getPopupContainer() {
          return document.getElementById('area2');
        },
        overlay: Header_menuCity()
      }, external__react__default.a.createElement("span", {
        className: "dropdown-container"
        ...
        className: "Body-1MediumBlackLeft city-name"
      }, "All cities")))), external__react__default.a.createElement("div", {
        className: "left"
        ...
        id: "burger"
      }, external__react__default.a.createElement("span", null, " \xA0"), external__react__default.a.createElement("span", null, " \xA0"), external__react__default.a.createElement("span", null, " \xA0"), external__react__default.a.createElement("span", null, " \xA0")))), external__react__default.a.createElement("div", {
      ...
      }, "Catering")), external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/nearby"
      }, external__react__default.a.createElement("a", {
        className: "item Body-1MediumGreyCenter"
        ...
        className: "item Body-1MediumGreyCenter"
      }, "Food Trucks")), isLoggedIn ? !isLoadingGetUser && userData ? external__react__default.a.createElement(dropdown__default.a, {
        getPopupContainer: function getPopupContainer() {
        ...
        id: "area",
        className: "item Body-1MediumBlackLeft"
      }, userData.name, external__react__default.a.createElement("img", {
        alt: "avatar",
        ...
        onClick: toggleSignInModal,
        className: "button-container button-container-login ButtonBlackCenter"
      }, "LOGIN"), external__react__default.a.createElement(button__default.a, {
        onClick: toggleSignUpModal,
        className: "button-container ButtonWhiteCenter",
        type: "primary"
      }, "SIGN UP")))));
...
var external__react_share_ = __webpack_require__(107);
var external__react_share__default = /*#__PURE__*/__webpack_require__.n(external__react_share_);

// CONCATENATED MODULE: ./src/components/common/shareModal/ShareModal.js


function ShareModal__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { ShareModal__typeof = function _typeof(obj) { return typeof obj; }; } else { ShareModal__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return ShareModal__typeof(obj); }

function ShareModal__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ShareModal__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function ShareModal__createClass(Constructor, protoProps, staticProps) { if (protoProps) ShareModal__defineProperties(Constructor.prototype, protoProps); if (staticProps) ShareModal__defineProperties(Constructor, staticProps); return Constructor; }

function ShareModal__possibleConstructorReturn(self, call) { if (call && (ShareModal__typeof(call) === "object" || typeof call === "function")) { return call; } return ShareModal__assertThisInitialized(self); }

function ShareModal__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function ShareModal__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }




var ShareModal_logo = "/static/images/logo-vertical.png";

var ShareModal_ShareModal =
/*#__PURE__*/
function (_Component) {
  ShareModal__inherits(ShareModal, _Component);

  function ShareModal(props) {
    var _this;

    ShareModal__classCallCheck(this, ShareModal);

    _this = ShareModal__possibleConstructorReturn(this, (ShareModal.__proto__ || Object.getPrototypeOf(ShareModal)).call(this, props));
    _this.state = {};
    return _this;
  }

  ShareModal__createClass(ShareModal, [{
    key: "render",
    value: function render() {
      var _props = this.props,
          handleCancel = _props.handleCancel,
          visible = _props.visible;
      var url = "";
      if (routes["Router"] && routes["Router"].router && routes["Router"].router.asPath) url = routes["Router"].router.asPath;
      return external__react__default.a.createElement(modal__default.a, {
        ...
        alt: "logo",
        src: ShareModal_logo
      })), external__react__default.a.createElement(external__react_share_["FacebookShareButton"], {
        url: "https://gotruckster.com/" + url,
        className: "social-button-container"
      }, external__react__default.a.createElement(external__react_share_["FacebookIcon"], {
        size: 32,
        round: true
      }), external__react__default.a.createElement("div", {
...
/* harmony default export */ var shareModal_ShareModal = (ShareModal_ShareModal);
...
var external__react_facebook_login_ = __webpack_require__(108);
var external__react_facebook_login__default = /*#__PURE__*/__webpack_require__.n(external__react_facebook_login_);

// EXTERNAL MODULE: external "react-google-login"
var external__react_google_login_ = __webpack_require__(109);
var external__react_google_login__default = /*#__PURE__*/__webpack_require__.n(external__react_google_login_);

// EXTERNAL MODULE: ./config.js
var config = __webpack_require__(12);

// CONCATENATED MODULE: ./src/components/signIn/SignInModal.jsx
...
function SignInModal__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { SignInModal__typeof = function _typeof(obj) { return typeof obj; }; } else { SignInModal__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return SignInModal__typeof(obj); }

function SignInModal__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function SignInModal__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function SignInModal__createClass(Constructor, protoProps, staticProps) { if (protoProps) SignInModal__defineProperties(Constructor.prototype, protoProps); if (staticProps) SignInModal__defineProperties(Constructor, staticProps); return Constructor; }

function SignInModal__possibleConstructorReturn(self, call) { if (call && (SignInModal__typeof(call) === "object" || typeof call === "function")) { return call; } return SignInModal__assertThisInitialized(self); }

function SignInModal__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function SignInModal__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var SignInModal_popOver = function popOver(messageArray) {
...
var SignInModal_SignInModal =
/*#__PURE__*/
function (_React$Component) {
  SignInModal__inherits(SignInModal, _React$Component);

  function SignInModal() {
    SignInModal__classCallCheck(this, SignInModal);

    return SignInModal__possibleConstructorReturn(this, (SignInModal.__proto__ || Object.getPrototypeOf(SignInModal)).apply(this, arguments));
  }

  SignInModal__createClass(SignInModal, [{
    key: "render",
    value: function render() {
      var _props = this.props,
          toggleSignInModal = _props.toggleSignInModal,
      ...
      return external__react__default.a.createElement("div", null, external__react__default.a.createElement(modal__default.a, {
      ...
      }, external__react__default.a.createElement(external__react_facebook_login__default.a, {
        cssClass: "facebook-login-button",
        appId: config["b" /* facebookAppID */] //autoload
        ,
        isMobile: false,
        autoLoad: false,
        fields: "email",
        ...
        className: "social-container"
      }, external__react__default.a.createElement(external__react_google_login__default.a, {
        icon: "fa-google",
        className: "google-login-button",
        clientId: config["d" /* googleClientID */],
        ...
        className: "divider"
      }, external__react__default.a.createElement("p", null, "or")), isLoginEmail ? external__react__default.a.createElement("div", {
        className: "form-login"
      }, external__react__default.a.createElement(popover__default.a, {
        placement: "right",
        content: messageSignIn && SignInModal_popOver(messageSignIn),
      ...
      }, external__react__default.a.createElement(FormItem, null, getFieldDecorator('password', {
        rules: [{
          required: true,
      ...
      }, "Forgot password ?"), external__react__default.a.createElement("p", {
        ...
        className: "ButtonWhiteCenter"
      }, "LOGIN BY EMAIL"))), external__react__default.a.createElement("div", {
        className: "divider"
      }), external__react__default.a.createElement("div", {
        className: "text-highlight"
      }, "Don't have account?", external__react__default.a.createElement("a", {
        onClick: toggleSignUpModal
      }, " Sign Up"))));
    }
  }]);
...
/* harmony default export */ var signIn_SignInModal = (SignInModal_SignInModal);
// EXTERNAL MODULE: ./src/components/signIn/_signIn.less
var _signIn = __webpack_require__(110);
var _signIn_default = /*#__PURE__*/__webpack_require__.n(_signIn);

// CONCATENATED MODULE: ./src/components/signIn/SignInModalContainer.jsx


function SignInModalContainer__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { SignInModalContainer__typeof = function _typeof(obj) { return typeof obj; }; } else { SignInModalContainer__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return SignInModalContainer__typeof(obj); }

function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }

function SignInModalContainer__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function SignInModalContainer__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function SignInModalContainer__createClass(Constructor, protoProps, staticProps) { if (protoProps) SignInModalContainer__defineProperties(Constructor.prototype, protoProps); if (staticProps) SignInModalContainer__defineProperties(Constructor, staticProps); return Constructor; }

function SignInModalContainer__possibleConstructorReturn(self, call) { if (call && (SignInModalContainer__typeof(call) === "object" || typeof call === "function")) { return call; } return SignInModalContainer__assertThisInitialized(self); }

function SignInModalContainer__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function SignInModalContainer__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }





var SignInModalContainer_SignInModalContainer =
/*#__PURE__*/
function (_Component) {
  SignInModalContainer__inherits(SignInModalContainer, _Component);

  function SignInModalContainer(props) {
    var _this;

    SignInModalContainer__classCallCheck(this, SignInModalContainer);

    _this = SignInModalContainer__possibleConstructorReturn(this, (SignInModalContainer.__proto__ || Object.getPrototypeOf(SignInModalContainer)).call(this, props));
    _this.state = {
      email: '',
      password: '',
      isLoginEmail: false,
  ...
  SignInModalContainer__createClass(SignInModalContainer, [{
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement("div", null, external__react__default.a.createElement("style", {
        dangerouslySetInnerHTML: {
          __html: _signIn_default.a
        }
      }), external__react__default.a.createElement(signIn_SignInModal, _extends({}, this.state, this.props, {
...
SignInModalContainer_SignInModalContainer = form__default.a.create()(SignInModalContainer_SignInModalContainer);
/* harmony default export */ var signIn_SignInModalContainer = (SignInModalContainer_SignInModalContainer);
// CONCATENATED MODULE: ./src/components/signUp/SignUpModal.jsx
...
function SignUpModal__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { SignUpModal__typeof = function _typeof(obj) { return typeof obj; }; } else { SignUpModal__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return SignUpModal__typeof(obj); }

function SignUpModal__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function SignUpModal__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function SignUpModal__createClass(Constructor, protoProps, staticProps) { if (protoProps) SignUpModal__defineProperties(Constructor.prototype, protoProps); if (staticProps) SignUpModal__defineProperties(Constructor, staticProps); return Constructor; }

function SignUpModal__possibleConstructorReturn(self, call) { if (call && (SignUpModal__typeof(call) === "object" || typeof call === "function")) { return call; } return SignUpModal__assertThisInitialized(self); }

function SignUpModal__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function SignUpModal__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }


var SignUpModal_FormItem = form__default.a.Item;
var userIcon = '/static/images/user-icon.png';
var SignUpModal_mailIcon = '/static/images/mail-icon.png';
var SignUpModal_lockIcon = '/static/images/lock-icon.png';
var phoneIcon = '/static/images/phone-icon.png';

var SignUpModal_popOver = function popOver(messageArray) {
  return messageArray.map(function (item, index) {
    return external__react__default.a.createElement("div", {
      key: index
    }, item);
...
var SignUpModal_SignUpModal =
/*#__PURE__*/
function (_React$Component) {
  SignUpModal__inherits(SignUpModal, _React$Component);

  function SignUpModal() {
    SignUpModal__classCallCheck(this, SignUpModal);

    return SignUpModal__possibleConstructorReturn(this, (SignUpModal.__proto__ || Object.getPrototypeOf(SignUpModal)).apply(this, arguments));
  }

  SignUpModal__createClass(SignUpModal, [{
    key: "render",
    value: function render() {
      var _props = this.props,
          toggleSignInModal = _props.toggleSignInModal,
      ...
      return external__react__default.a.createElement("div", null, external__react__default.a.createElement(modal__default.a, {
      ...
      }, "Sign up with ", external__react__default.a.createElement("a", null, "Facebook"), "  or ", external__react__default.a.createElement("a", null, "Google"), " "), external__react__default.a.createElement("div", {
        className: "divider"
      }, external__react__default.a.createElement("p", null, "or")), external__react__default.a.createElement("div", {
        className: "form-login"
      }, external__react__default.a.createElement(SignUpModal_FormItem, {
        style: {
          marginBottom: '24px'
        }
        ...
        placement: "right",
        content: messageSignUp && SignUpModal_popOver(messageSignUp),
      ...
      }, external__react__default.a.createElement(SignUpModal_FormItem, null, getFieldDecorator('password', {
        rules: [{
          required: true,
          message: "Please enter your password"
        }]
        ...
        suffix: external__react__default.a.createElement("img", {
          className: "img-icon",
          alt: "password",
          src: SignUpModal_lockIcon
        }),
        type: "password",
        placeholder: "Password"
      })))), external__react__default.a.createElement(SignUpModal_FormItem, null, getFieldDecorator('c_password', {
        rules: [{
          required: true,
      ...
      }, getFieldDecorator('refer_code', {})(external__react__default.a.createElement(input__default.a, {
      ...
      }, "By using Truckster you agree to the ", external__react__default.a.createElement("a", null, "Terms of Service"), ", ", external__react__default.a.createElement("a", null, "Privacy Policy"), " and", external__react__default.a.createElement("a", null, " Cookie Policy"), "."), external__react__default.a.createElement(SignUpModal_FormItem, null, external__react__default.a.createElement("div", {
        ...
        className: "ButtonWhiteCenter"
      }, "CREATE A ACCOUNT")))), external__react__default.a.createElement("p", {
        className: "alert-message"
      })), external__react__default.a.createElement("div", {
        className: "divider"
      }), external__react__default.a.createElement("div", {
...
/* harmony default export */ var signUp_SignUpModal = (SignUpModal_SignUpModal);
// CONCATENATED MODULE: ./src/components/signUp/SignUpModalContainer.jsx


function SignUpModalContainer__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { SignUpModalContainer__typeof = function _typeof(obj) { return typeof obj; }; } else { SignUpModalContainer__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return SignUpModalContainer__typeof(obj); }

function SignUpModalContainer__extends() { SignUpModalContainer__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return SignUpModalContainer__extends.apply(this, arguments); }

function SignUpModalContainer__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function SignUpModalContainer__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function SignUpModalContainer__createClass(Constructor, protoProps, staticProps) { if (protoProps) SignUpModalContainer__defineProperties(Constructor.prototype, protoProps); if (staticProps) SignUpModalContainer__defineProperties(Constructor, staticProps); return Constructor; }

function SignUpModalContainer__possibleConstructorReturn(self, call) { if (call && (SignUpModalContainer__typeof(call) === "object" || typeof call === "function")) { return call; } return SignUpModalContainer__assertThisInitialized(self); }

function SignUpModalContainer__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function SignUpModalContainer__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }





var SignUpModalContainer_SignUpModalContainer =
/*#__PURE__*/
function (_Component) {
  SignUpModalContainer__inherits(SignUpModalContainer, _Component);

  function SignUpModalContainer(props) {
    var _this;

    SignUpModalContainer__classCallCheck(this, SignUpModalContainer);

    _this = SignUpModalContainer__possibleConstructorReturn(this, (SignUpModalContainer.__proto__ || Object.getPrototypeOf(SignUpModalContainer)).call(this, props));
    _this.state = {
      email: '',
      password: ''
    };
  ...
  SignUpModalContainer__createClass(SignUpModalContainer, [{
    key: "handleSignUp",
    ...
    value: function componentDidMount() {
      ...
      if (routes["Router"].query && routes["Router"].query.referCode) {
        this.props.toggleSignUpModal();
        form.setFieldsValue({
          "refer_code": routes["Router"].query.referCode
        });
      }
    }
  }, {
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement(signUp_SignUpModal, SignUpModalContainer__extends({}, this.state, this.props, {
...
SignUpModalContainer_SignUpModalContainer = form__default.a.create()(SignUpModalContainer_SignUpModalContainer);
/* harmony default export */ var signUp_SignUpModalContainer = (SignUpModalContainer_SignUpModalContainer);
...
// CONCATENATED MODULE: ./src/components/forgot/ForgotModal.jsx
...
function ForgotModal__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { ForgotModal__typeof = function _typeof(obj) { return typeof obj; }; } else { ForgotModal__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return ForgotModal__typeof(obj); }

function ForgotModal__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ForgotModal__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function ForgotModal__createClass(Constructor, protoProps, staticProps) { if (protoProps) ForgotModal__defineProperties(Constructor.prototype, protoProps); if (staticProps) ForgotModal__defineProperties(Constructor, staticProps); return Constructor; }

function ForgotModal__possibleConstructorReturn(self, call) { if (call && (ForgotModal__typeof(call) === "object" || typeof call === "function")) { return call; } return ForgotModal__assertThisInitialized(self); }

function ForgotModal__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function ForgotModal__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }


var ForgotModal_FormItem = form__default.a.Item;
var backIcon = '/static/images/back-icon.png';
var ForgotModal_mailIcon = '/static/images/mail-icon.png';

var ForgotModal_ForgotModal =
/*#__PURE__*/
function (_React$Component) {
  ForgotModal__inherits(ForgotModal, _React$Component);

  function ForgotModal() {
    ForgotModal__classCallCheck(this, ForgotModal);

    return ForgotModal__possibleConstructorReturn(this, (ForgotModal.__proto__ || Object.getPrototypeOf(ForgotModal)).apply(this, arguments));
  }

  ForgotModal__createClass(ForgotModal, [{
    key: "render",
    value: function render() {
      var _props = this.props,
          toggleSignInModal = _props.toggleSignInModal,
      ...
      return external__react__default.a.createElement("div", null, external__react__default.a.createElement(modal__default.a, {
        ...
        className: "form-login"
      }, external__react__default.a.createElement(ForgotModal_FormItem, {
        style: {
          marginBottom: '24px'
        }
      }, getFieldDecorator('email', {
        ...
        onClick: toggleSignInModal
      }, "BACK TO LOGIN")), external__react__default.a.createElement(col__default.a, {
        span: 10
      }, "   ", external__react__default.a.createElement("div", {
        className: "button-container email"
      }, external__react__default.a.createElement(button__default.a, {
...
var _forgot = __webpack_require__(111);
var _forgot_default = /*#__PURE__*/__webpack_require__.n(_forgot);

// CONCATENATED MODULE: ./src/components/forgot/ForgotModalContainer.jsx
...
function ForgotModalContainer__extends() { ForgotModalContainer__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return ForgotModalContainer__extends.apply(this, arguments); }
...
function (_Component) {
  ...
  ForgotModalContainer__createClass(ForgotModalContainer, [{
    ...
    value: function render() {
      ...
      }), external__react__default.a.createElement(forgot_ForgotModal, ForgotModalContainer__extends({}, this.state, this.props, {
...
/* harmony default export */ var forgot_ForgotModalContainer = (ForgotModalContainer_ForgotModalContainer);
...
// CONCATENATED MODULE: ./src/actions/authAction.js



var cookies = new external__react_cookie_["Cookies"](); // Sign up action

function requestSignUp(isLoadingSignUp) {
  return {
    type: types["_46" /* REQUEST_SIGN_UP */],
...
function signUpSuccess(response) {
  return function (dispatch) {
    dispatch({
      type: types["_61" /* SIGN_UP_SUCCESS */],
      response: response
    });
  };
}
...
function requestLoginSocial(isLoadingLoginSocial) {
  return {
    type: types["_35" /* REQUEST_LOGIN_SOCIAL */],
...
function loginSocialSuccess(response) {
  return function (dispatch) {
    dispatch({
      type: types["U" /* LOGIN_SOCIAL_SUCCESS */],
      response: response
    });
  };
}
function loginSocialError(response) {
  return function (dispatch) {
    dispatch({
      type: types["T" /* LOGIN_SOCIAL_ERROR */],
      response: response
    });
  };
} // Sign In action
...
function requestSignIn(isLoadingSignIn) {
  return {
    type: types["_45" /* REQUEST_SIGN_IN */],
...
function signInSuccess(response) {
  return function (dispatch) {
    dispatch({
      type: types["_59" /* SIGN_IN_SUCCESS */],
      response: response
    });
  };
}
function signInError(response) {
  return function (dispatch) {
    dispatch({
      type: types["_58" /* SIGN_IN_ERROR */],
      response: response
    });
  };
} //Check user login

function authAction_checkLogin() {
  ...
  return function (dispatch) {
    if (token) {
      ...
      dispatch(Object(profileApi["b" /* getUser */])());
...
function requestLogOut(isLoadingLogOut) {
  return {
    type: types["_36" /* REQUEST_LOG_OUT */],
...
// CONCATENATED MODULE: ./src/api/authApi.js
function authApi__objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { authApi__defineProperty(target, key, source[key]); }); } return target; }

function authApi__defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var authApi_cookies = new external__react_cookie_["Cookies"](); // Sign Up api

var authApi_signUp = function signUp(data) {
  return function (dispatch) {
    dispatch(requestSignUp(true));
    external__jquery__default.a.ajax({
      type: 'POST',
      url: config["a" /* apiUrl */] + 'api/register',
      headers: {
        'Accept': 'application/json',
      ...
      success: function success(response, status, xhr) {
        ...
        authApi_cookies.set('token', response.token, {
          path: '/'
        });
        window.location.replace("/");
      },
      error: function error(_error) {
        if (_error.responseJSON.errors.email) dispatch(signUpError(authApi__objectSpread({}, _error, {
          status: 404
        })));else dispatch(signUpError(authApi__objectSpread({}, _error, {
          status: 422
        })));
        dispatch(Object(toggleAction["d" /* toggleErrorSignUpPopOver */])());
      }
    });
  };
}; // Sign In api

var authApi_signIn = function signIn(data) {
  return function (dispatch) {
    dispatch(requestSignIn(true));
    external__jquery__default.a.ajax({
      type: 'POST',
      url: config["a" /* apiUrl */] + 'api/login',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json'
      },
      data: JSON.stringify(data),
      success: function success(response, status, xhr) {
        dispatch(Object(toggleAction["g" /* toggleSignInModal */])());
      ...
      error: function error(_error2) {
        dispatch(signInError(_error2));
        dispatch(Object(toggleAction["c" /* toggleErrorSignInPopOver */])());
      }
    });
  };
}; // Log out api

var authApi_logOut = function logOut() {
  return function (dispatch) {
    ...
    external__jquery__default.a.ajax({
      ...
      url: config["a" /* apiUrl */] + 'api/user/show',
      beforeSend: function beforeSend(xhr) {
        xhr.setRequestHeader('Authorization', "Bearer " + authApi_cookies.get('token', {
          doNotParse: true
        }));
      },
      headers: {
      ...
      error: function error(_error3) {
        dispatch(logOutError(_error3));
      }
    });
  };
}; // Login social api

var authApi_loginSocial = function loginSocial(data) {
  return function (dispatch) {
    dispatch(requestLoginSocial(true));
    external__jquery__default.a.ajax({
      type: 'POST',
      url: config["a" /* apiUrl */] + 'api/social-login/' + data.provider,
      headers: {
        "Accept": "application/json",
        "Content-Type": "application/json"
      },
      ...
      success: function success(response, status, xhr) {
        ...
        dispatch(loginSocialSuccess(response));
        window.location.replace("/");
      },
      error: function error(_error4) {
        dispatch(loginSocialError(_error4));
      }
    });
  };
};
...
function (_Component) {
  ...
  HeaderContainer__createClass(HeaderContainer, [{
    ...
    value: function componentDidMount() {
      ...
      notification__default.a.config({
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.truckSearchResult && nextProps.brewerySearchResult) {
        ...
        nextProps.brewerySearchResult.forEach(function (item) {
          brewerySearch.push(HeaderContainer__objectSpread({}, item, {
            id: item.id,
            type: "brewery",
            name: item.name,
        ...
        nextProps.truckSearchResult.forEach(function (item) {
          truckSearch.push(HeaderContainer__objectSpread({}, item, {
            id: item.id,
            type: "truck",
            name: item.name,
            cover_photo: item.cover_photo,
    ...
    value: function render() {
      ...
      }), external__react__default.a.createElement(header_Header, HeaderContainer__extends({}, this.state, this.props, {
      ...
      })), external__react__default.a.createElement(signIn_SignInModalContainer, this.props), external__react__default.a.createElement(signUp_SignUpModalContainer, this.props), external__react__default.a.createElement(forgot_ForgotModalContainer, this.props), external__react__default.a.createElement(AnnounceModal["a" /* default */], {
      ...
      }), external__react__default.a.createElement(shareModal_ShareModal, {
        url: this.props.url,
...
function mapDispatchToProps(dispatch) {
  return Object(external__redux_["bindActionCreators"])({
    getCuisineList: truckApi["a" /* getCuisineList */],
    ...
    toggleSignInModal: toggleAction["g" /* toggleSignInModal */],
    toggleSignUpModal: toggleAction["h" /* toggleSignUpModal */],
    toggleForgotModal: toggleAction["e" /* toggleForgotModal */],
    signIn: authApi_signIn,
    signUp: authApi_signUp,
    logOut: authApi_logOut,
    loginSocial: authApi_loginSocial,
    searchTruck: truckApi["e" /* searchTruck */],
    searchBrewery: breweryApi["c" /* searchBrewery */],
    checkLogin: authAction_checkLogin,
    search: searchApi["a" /* search */]
  }, dispatch);
}
/* harmony default export */ var header_HeaderContainer = (Object(external__react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(HeaderContainer_HeaderContainer));
...
var Footer_logo = "/static/images/logo-vertical.png";
...
function (_Component) {
  ...
  Footer__createClass(Footer, [{
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement("footer", {
      ...
      }, "Download the app"), external__react__default.a.createElement(row__default.a, {
        gutter: 16,
        ...
        prefetch: true,
        to: "/about"
      }, external__react__default.a.createElement("a", null, "About us")), external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/privacy"
      }, external__react__default.a.createElement("a", null, "Privacy & Terms")), external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/help"
      }, external__react__default.a.createElement("a", null, "Help")), external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/info"
      }, external__react__default.a.createElement("a", null, "Blog"))), external__react__default.a.createElement(col__default.a, {
        md: 4,
        className: "column"
      }, external__react__default.a.createElement("h3", {
        className: "SubheadingBlackLeft"
        ...
        prefetch: true,
        to: "/food-truck/co/denver/all"
      }, external__react__default.a.createElement("a", null, "Find trucks")), external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/food-truck/co/denver/cuisines"
      }, external__react__default.a.createElement("a", null, "Cuisine")), external__react__default.a.createElement(routes["Link"], {
        prefetch: true,
        to: "/event/co/denver"
      }, external__react__default.a.createElement("a", null, "Events"))), external__react__default.a.createElement(col__default.a, {
        md: 4,
        className: "column"
      }, external__react__default.a.createElement("h3", {
        className: "SubheadingBlackLeft"
      }, "Vendor"), external__react__default.a.createElement("a", {
        ...
        target: "_blank"
      }, "Vendor login"), external__react__default.a.createElement("a", {
        href: "mailto:info@gotruckster.com"
      }, "Add my truck")), external__react__default.a.createElement(col__default.a, {
        xs: 24,
        sm: 24,
        md: 5,
        className: "social"
...
// CONCATENATED MODULE: ./src/components/footer/DownloadApp.js


function DownloadApp__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { DownloadApp__typeof = function _typeof(obj) { return typeof obj; }; } else { DownloadApp__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return DownloadApp__typeof(obj); }
...
function DownloadApp__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function DownloadApp__createClass(Constructor, protoProps, staticProps) { if (protoProps) DownloadApp__defineProperties(Constructor.prototype, protoProps); if (staticProps) DownloadApp__defineProperties(Constructor, staticProps); return Constructor; }

function DownloadApp__possibleConstructorReturn(self, call) { if (call && (DownloadApp__typeof(call) === "object" || typeof call === "function")) { return call; } return DownloadApp__assertThisInitialized(self); }

function DownloadApp__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function DownloadApp__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }


var DownloadApp_logo = "/static/images/logo-app.png";
var closeIcon = "/static/images/close-icon.svg";

var DownloadApp_DownloadApp =
/*#__PURE__*/
function (_Component) {
  ...
  function DownloadApp(props) {
    ...
    _this = DownloadApp__possibleConstructorReturn(this, (DownloadApp.__proto__ || Object.getPrototypeOf(DownloadApp)).call(this, props));
    _this.state = {};
    return _this;
  }

  DownloadApp__createClass(DownloadApp, [{
    key: "render",
    value: function render() {
      var _props = this.props,
      ...
      return external__react__default.a.createElement("div", {
        ...
        src: DownloadApp_logo,
        alt: "truck"
      })), external__react__default.a.createElement("div", {
        className: "download-content"
      }, external__react__default.a.createElement("div", {
        className: "ButtonWhiteCenter"
      }, "Use the Truckster App "), external__react__default.a.createElement("div", {
        className: "CaptionGreyCenter"
      }, "Discover food trucks easier")))), external__react__default.a.createElement("div", {
        className: "get-app-button"
      }, external__react__default.a.createElement(button__default.a, {
        type: "primary"
      }, paramsDeepLink ? external__react__default.a.createElement("a", {
        href: paramsDeepLink
      }, "OPEN IN APP") : external__react__default.a.createElement("a", {
        href: url
      }, "GET APP"))));
    }
  }]);
...
/* harmony default export */ var footer_DownloadApp = (DownloadApp_DownloadApp);
...
var router_ = __webpack_require__(113);
var router__default = /*#__PURE__*/__webpack_require__.n(router_);

// EXTERNAL MODULE: ./src/components/footer/_footer.less
...
function FooterContainer__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { FooterContainer__typeof = function _typeof(obj) { return typeof obj; }; } else { FooterContainer__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return FooterContainer__typeof(obj); }

function FooterContainer__extends() { FooterContainer__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return FooterContainer__extends.apply(this, arguments); }

function FooterContainer__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function FooterContainer__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function FooterContainer__createClass(Constructor, protoProps, staticProps) { if (protoProps) FooterContainer__defineProperties(Constructor.prototype, protoProps); if (staticProps) FooterContainer__defineProperties(Constructor, staticProps); return Constructor; }

function FooterContainer__possibleConstructorReturn(self, call) { if (call && (FooterContainer__typeof(call) === "object" || typeof call === "function")) { return call; } return FooterContainer__assertThisInitialized(self); }

function FooterContainer__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function FooterContainer__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var FooterContainer_FooterContainer =
/*#__PURE__*/
function (_Component) {
  FooterContainer__inherits(FooterContainer, _Component);

  function FooterContainer(props) {
    var _this;

    FooterContainer__classCallCheck(this, FooterContainer);

    _this = FooterContainer__possibleConstructorReturn(this, (FooterContainer.__proto__ || Object.getPrototypeOf(FooterContainer)).call(this, props));
    _this.state = {
  ...
  FooterContainer__createClass(FooterContainer, [{
    key: "render",
    value: function render() {
      var _props = this.props,
      ...
      return router.pathname.includes("/event") || router.pathname.includes("/profile") || router.pathname.includes("/pairing") || router.pathname.includes("/nearby") || router.pathname.includes("/user") || router.pathname.includes("/success") || router.pathname.includes("/activities") ? external__react__default.a.createElement("div", null) : external__react__default.a.createElement("div", null, external__react__default.a.createElement("style", {
        dangerouslySetInnerHTML: {
          __html: _footer_default.a
        }
      }), external__react__default.a.createElement(footer_Footer, FooterContainer__extends({}, this.state, this.props)), external__react_device_detect_["isMobile"] && visibleDeepLink && external__react__default.a.createElement(footer_DownloadApp, {
        paramsDeepLink: paramsDeepLink,
        toggleDeepLink: toggleDeepLink,
        isIOS: external__react_device_detect_["isIOS"],
        isAndroid: external__react_device_detect_["isAndroid"]
      }));
    }
  }]);
...
function FooterContainer_mapStateToProps(state) {
  3;
  return {
...
function FooterContainer_mapDispatchToProps(dispatch) {
  return Object(external__redux_["bindActionCreators"])({
    toggleAnnounceModal: toggleAction["a" /* toggleAnnounceModal */],
    toggleDeepLink: deepLinkAction["b" /* toggleDeepLink */]
  }, dispatch);
}
/* harmony default export */ var footer_FooterContainer = (Object(router_["withRouter"])(Object(external__react_redux_["connect"])(FooterContainer_mapStateToProps, FooterContainer_mapDispatchToProps)(FooterContainer_FooterContainer)));
// EXTERNAL MODULE: ./src/styles/index.less
var styles = __webpack_require__(115);
var styles_default = /*#__PURE__*/__webpack_require__.n(styles);

// EXTERNAL MODULE: ./src/components/common/categoryCard/_categoryCard.less
var _categoryCard = __webpack_require__(116);
var _categoryCard_default = /*#__PURE__*/__webpack_require__.n(_categoryCard);

// EXTERNAL MODULE: ./src/components/common/eventCard/_eventCard.less
var _eventCard = __webpack_require__(117);
var _eventCard_default = /*#__PURE__*/__webpack_require__.n(_eventCard);

// EXTERNAL MODULE: ./src/components/common/truckCard/_truckCard.less
var _truckCard = __webpack_require__(118);
var _truckCard_default = /*#__PURE__*/__webpack_require__.n(_truckCard);

// EXTERNAL MODULE: ./src/components/common/truckNewCard/_truckNewCard.less
var _truckNewCard = __webpack_require__(119);
var _truckNewCard_default = /*#__PURE__*/__webpack_require__.n(_truckNewCard);

// EXTERNAL MODULE: ./src/components/common/pairingCard/_pairingCard.less
var _pairingCard = __webpack_require__(120);
var _pairingCard_default = /*#__PURE__*/__webpack_require__.n(_pairingCard);

// EXTERNAL MODULE: ./src/components/common/section/_section.less
var _section = __webpack_require__(121);
var _section_default = /*#__PURE__*/__webpack_require__.n(_section);

// EXTERNAL MODULE: ./src/components/common/placeholder/_placeholder.less
var _placeholder = __webpack_require__(122);
var _placeholder_default = /*#__PURE__*/__webpack_require__.n(_placeholder);

// EXTERNAL MODULE: ./src/components/common/announceModal/_announceModal.less
var _announceModal = __webpack_require__(123);
var _announceModal_default = /*#__PURE__*/__webpack_require__.n(_announceModal);

// EXTERNAL MODULE: ./src/components/common/searchBar/_searchBar.less
var _searchBar = __webpack_require__(124);
var _searchBar_default = /*#__PURE__*/__webpack_require__.n(_searchBar);

// EXTERNAL MODULE: ./src/components/common/CustomCarousel/_customCarousel.less
var _customCarousel = __webpack_require__(125);
var _customCarousel_default = /*#__PURE__*/__webpack_require__.n(_customCarousel);

// EXTERNAL MODULE: ./src/components/common/calendar/_calendar.less
var _calendar = __webpack_require__(126);
var _calendar_default = /*#__PURE__*/__webpack_require__.n(_calendar);

// EXTERNAL MODULE: ./src/components/common/shareModal/_shareModal.less
var _shareModal = __webpack_require__(127);
var _shareModal_default = /*#__PURE__*/__webpack_require__.n(_shareModal);

// EXTERNAL MODULE: ./src/components/common/userReview/_userReview.less
var _userReview = __webpack_require__(128);
var _userReview_default = /*#__PURE__*/__webpack_require__.n(_userReview);

// EXTERNAL MODULE: ./src/components/common/renderContainer/_renderContainer.less
var _renderContainer = __webpack_require__(129);
var _renderContainer_default = /*#__PURE__*/__webpack_require__.n(_renderContainer);

// EXTERNAL MODULE: ./src/components/common/reviewModify/_reviewModify.less
var _reviewModify = __webpack_require__(130);
var _reviewModify_default = /*#__PURE__*/__webpack_require__.n(_reviewModify);

// EXTERNAL MODULE: ./src/components/common/reviewSummary/_reviewSummary.less
var _reviewSummary = __webpack_require__(131);
var _reviewSummary_default = /*#__PURE__*/__webpack_require__.n(_reviewSummary);
  ...
  _app__createClass(MyApp, [{
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement(app_["Container"], null, external__react__default.a.createElement(external__react_redux_["Provider"], {
        store: store
      }, external__react__default.a.createElement("div", null, external__react__default.a.createElement("style", {
        dangerouslySetInnerHTML: {
          __html: styles_default.a + _eventCard_default.a + _truckCard_default.a + _truckNewCard_default.a + _pairingCard_default.a + _section_default.a + _placeholder_default.a + _announceModal_default.a + _searchBar_default.a + _categoryCard_default.a + _customCarousel_default.a + _calendar_default.a + _userReview_default.a + _renderContainer_default.a + _reviewModify_default.a + _reviewSummary_default.a + _shareModal_default.a
        }
      }), external__react__default.a.createElement(header_HeaderContainer, pageProps), external__react__default.a.createElement(Component, pageProps), external__react__default.a.createElement(footer_FooterContainer, pageProps))));
    }
  }], [{
    key: "getInitialProps",
    value: function () {
...
/* harmony default export */ var _app = __webpack_exports__["default"] = (external__next_redux_wrapper__default()(initializeStore)(_app_MyApp));
