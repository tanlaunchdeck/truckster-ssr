...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TruckDetailRedirect; });
...
var TruckDetailRedirect =
/*#__PURE__*/
function (_Component) {
  _inherits(TruckDetailRedirect, _Component);

  function TruckDetailRedirect() {
    _classCallCheck(this, TruckDetailRedirect);

    return _possibleConstructorReturn(this, (TruckDetailRedirect.__proto__ || Object.getPrototypeOf(TruckDetailRedirect)).apply(this, arguments));
  }

  _createClass(TruckDetailRedirect, null, [{
    key: "getInitialProps",
    value: function () {
              ...
              case 0:
                if (ctx && ctx.req) {
                  ctx.res.writeHead(301, {
                    Location: "/food-truck/co/denver/all"
                  });
                  ctx.res.end();
                } else {
                  __WEBPACK_IMPORTED_MODULE_2__routes__["Router"].push("/food-truck/co/denver/all");
                }
